...
@Entity
@Table(name="MEASURE")
public class OhrMeasure implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator = "ohrMeasureSeq")
	@SequenceGenerator(name = "ohrMeasureSeq", sequenceName = "OHR_MEASURE_SEQ")
