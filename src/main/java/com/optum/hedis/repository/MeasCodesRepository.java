...
public interface MeasCodesRepository extends JpaRepository<MeasCodes, Long>,JpaSpecificationExecutor<MeasCodes> {
	...
	String DELETE_MEASURE_IN_TABLE = "delete MeasCodes where id.measureName = :measureName and id.measurementYr = :selectedYearToDeleteMeasure";
	...
	List<Object[]> getMeasCodesTable();
	
	@Query(value = GET_FULL_TABLE)
	List<Object[]> getMeasCodesFullTable();
}
